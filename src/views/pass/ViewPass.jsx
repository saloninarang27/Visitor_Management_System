...
import AddNewVisitor from '../visitor/AddNewVisitor';
...
const ViewPass = ({ open, onClose, passData }) => {
    ...
    return (
        ...
        >
            <Paper className="bg-white p-4 printableArea shadow-md w-full" style={{ width: '800px', height: '360px' }}>
                <div className="grid grid-cols-3 gap-4 items-start border-2 border-gray-300 rounded-lg shadow-sm ">
                    ...
                    <div className="col-span-1 p-2 border-r-2 border-gray-300">
                        <div className='flex flex-col items-center space-y-4 pb-2'>
                            ...
                            {passData?.visitor.image ? (
                                ...
                                <div className="h-86 w-32 border-2 border-gray-300 flex items-center justify-center text-white bg-customGreen rounded-xl">
                    ...
                    <div className="col-span-2 flex flex-col space-y-4">
                        <div className='p-2'>
                            <div className="flex justify-center p-2">
                                <h1 className="text-xl font-bold">Visitor Entry Pass</h1>
                            </div>
                            <div className="flex">
                                ...
                                <div className="flex-1 flex flex-col space-y-4 p-2 m-6">
                                    <InfoItem label="To-Visit" value={passData?.whom_to_visit} />
                                    <InfoItem label="Department" value={passData?.visiting_department} />
                                    <InfoItem label="Mobile-No" value={passData?.visitor.phone || 'N/A'} />
                                    
                                </div>
                            </div>
                            <div className="flex justify-left p-2 mt-10 ">
                                 <InfoItem label="Visitor Signature" />
                                <InfoItem label="Signature ERNET India Officer"/>
                            </div>
                        </div>
                    </div>
                </div>
