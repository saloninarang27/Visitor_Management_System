    ...
    return (
        <div style={{marginBottom:"55px"}}>
            <div className="flex justify-between items-center m-6 mt-10">
                <div>
                    <input
                        className="appearance-none border border-blue-500 rounded-3xl w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-green-700"
                        type="text"
                    ...
                    <table className="text-left w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th className="py-4 px-6 bg-blue-100 font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Visitor Name</th>
                                <th className="py-4 px-6 bg-blue-100 font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Purpose</th>
                                <th className="py-4 px-6 bg-blue-100 font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Whom To Visit</th>
                                <th className="py-4 px-6 bg-blue-100 font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Visiting Department</th>
                                <th className="py-4 px-6 bg-blue-100 font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Created On</th>
                                <th className="py-4 px-6 bg-blue-100 font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Valid Until</th>
                            </tr>
                        </thead>
                        <tbody>
                            {passesData.map((pass, index) => (
                                <tr key={index} className="hover:bg-blue-50 cursor-pointer" onClick={() => handleRowClick(pass)}>
